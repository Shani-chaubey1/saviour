      ...
      <Link href={href} className="pc-card" onClick={handleCardClick}>
        <div className="pc-img-wrap">
          ...
          <div className="pc-badges">
            {status && (
              <span className="pc-badge pc-badge-green">{status}</span>
            )}
          ...
          <div className="pc-meta">
            {price && (
              <div className="pc-meta-item">
                <span className="pc-meta-k">Price</span>
        ...
        <style jsx global>{`
          ...
          .pc-card:hover {
            ...
            box-shadow: 0 20px 56px rgba(0, 104, 51, 0.15);
          }
          ...
          .pc-badge-green {
            background: rgba(0, 104, 51, 0.9);
            color: #fff;
          }
          .pc-badge-red {
            background: rgba(235, 50, 55, 0.9);
            color: #fff;
          }

...
export async function getProjects({ type, limit } = {}) {
  try {
    ...
    return (type ? SEED_PROJECTS.filter(p => p.type === type) : SEED_PROJECTS).slice(0, limit || 100);
  }
}
...
const DEFAULT_SETTINGS = {
  ...
  site_address: 'C Block-110, Sector 65, Noida – 201301',
  // Social
  ...
  stat_assets: '₹500Cr+',
  // Trust Banner
  trust_intro: 'Saviour Builders are one of the leading real estate developers in Delhi NCR. To provide an outstanding level of Houses & service to our buyers. Saviour Builders are dedicated to the highest standards, systems and performance necessary to fulfill all of your real estate dreams.',
  ...
  about_desc_1: 'M/s Saviour Builders Pvt. Ltd. (Saviour Group) is one of the leading real estate developers in Delhi-NCR. It has turned up as one of the eminent entities in the real estate sector of India, making a mark in delivering residential & commercial township projects.',
  about_desc_2: 'From building small residential projects to creating multi-dimensional mega townships, the Saviour Group has done it all with complete dedication to reach higher and build better.',
  ...
  mission_desc: 'To provide an outstanding level of Houses & service to our buyers. Saviour Builders are dedicated to the highest standards, systems, and performance necessary to fulfill all of your real estate dreams.',
  vision_title: 'Our Vision',
  vision_desc: 'We believe real estate is more than just building the proverbial four walls, it\'s about "Building a Better Life". This is the ideology with which we have delivered some of the most iconic addresses in Delhi/NCR.',
  quality_title: 'Quality Policy',
  quality_desc: 'We are committed to delight our customers by improving their quality of life. We continuously improve our processes and adopt ethical practices by engaging our employees and stakeholders.',
  // Why Choose Us
  why_1_title: 'Quality Policy',
  why_1_desc: 'We are committed to delight our customers by improving their quality of life. We continuously improve processes and adopt ethical practices by engaging our employees and stakeholders to surpass statutory and regulatory standards.',
  why_2_title: 'Green & Clean Environment',
  why_2_desc: 'Each urban area of Saviour Builders is built on the basis of "A place where living is in harmony with nature" — with greeneries, parks, squares, and water surfaces designed and arranged harmoniously.',
  why_3_title: 'We Build Value',
  why_3_desc: 'With our projects spanning residential, commercial and corporate construction, we at Saviour Builders aim to deliver excellence and comfort, with a touch of fairness and transparency in everything we do.',
  // Launching Soon
  launching_soon_title: 'Vridhi+ Premium Tower',
  launching_soon_desc: 'Step into your dream world where luxury meets lifestyle. Surrounded by a lush 7.5-acre park, Vridhi+ Premium Tower offers an eco-friendly environment, grand commercial spaces, and beautifully crafted 3 & 4 BHK premium residences — limited to just 192 units.',
  launching_soon_tags: '🌳 7.5-Acre Park,🏠 3 & 4 BHK,✨ 192 Units Only,🏙️ Premium Location',
  // Developments Section
  dev_1_title: 'Residential Developments',
  dev_1_desc: 'The Group successfully ventured into Real Estate by creating a series of residential spaces at strategic locations in Ghaziabad, Noida Extension and Yamuna Expressway — homes that blend comfort, design, and affordability.',
  ...
  dev_2_desc: 'At Saviour, we\'re not only shaping how people live and work, but we\'re also creating places that will last beyond our lifetime — sustainable, inclusive spaces contributing to the health and well-being of the community.',
  ...
  dev_3_desc: 'Real estate has been one of the best investment options for decades. Saviour offers the best products for people looking to invest — from Commercial Properties to homes, with an array of high-return investment options.',
  dev_3_image: 'https://saviourgroup.in/wp-content/uploads/2025/05/about.png',
  dev_3_link: '/contact-us',
  dev_3_tag: 'Investor',
  // Certifications Banner (below hero)
